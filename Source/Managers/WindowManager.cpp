...
namespace NGM
{
    namespace Manager
    {
        ...
        {
            actionManager.actions[ActionManager::ActionZoom]->setEnabled((Resource::Widget::CanZoomIn | Resource::Widget::CanZoomOut));
        }
        ...
        void WindowManager::setResourceWidget(Resource::Widget *widget)
        {
            if (resourceWidget != nullptr)
            {
                ...
                disconnect(resourceWidget, &Resource::Widget::canZoomIn, this, &WindowManager::canZoomIn);
                disconnect(resourceWidget, &Resource::Widget::canZoomOut, this, &WindowManager::canZoomOut);
                disconnect(resourceWidget, &Resource::Widget::canZoomIn, this, &WindowManager::canZoom);
                disconnect(resourceWidget, &Resource::Widget::canZoomOut, this, &WindowManager::canZoom);
                ...
                disconnect(actionManager.actions[ActionManager::ActionZoomIn], &QAction::triggered, resourceWidget, &Resource::Widget::zoomInRequest);
                disconnect(actionManager.actions[ActionManager::ActionZoomOut], &QAction::triggered, resourceWidget, &Resource::Widget::zoomOutRequest);
                disconnect(actionManager.actions[ActionManager::ActionZoom], &QAction::triggered, resourceWidget, &Resource::Widget::zoomRequest);
            }
            ...
            canZoomIn(settings & Resource::Widget::CanZoomIn);
            canZoomOut(settings & Resource::Widget::CanZoomOut);
            canZoom(settings & (Resource::Widget::CanZoomIn | Resource::Widget::CanZoomOut));
            ...
            connect(widget, &Resource::Widget::canZoomIn, this, &WindowManager::canZoomIn);
            connect(widget, &Resource::Widget::canZoomOut, this, &WindowManager::canZoomOut);
            connect(widget, &Resource::Widget::canZoomIn, this, &WindowManager::canZoom);
            connect(widget, &Resource::Widget::canZoomOut, this, &WindowManager::canZoom);
            ...
            connect(actionManager.actions[ActionManager::ActionZoomIn], &QAction::triggered, widget, &Resource::Widget::zoomInRequest);
            connect(actionManager.actions[ActionManager::ActionZoomOut], &QAction::triggered, widget, &Resource::Widget::zoomOutRequest);
            connect(actionManager.actions[ActionManager::ActionZoom], &QAction::triggered, widget, &Resource::Widget::zoomRequest);
